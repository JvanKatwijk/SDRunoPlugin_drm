...
std::complex<DRM_FLOAT> getTimeRef (uint8_t Mode,
...
std::complex<DRM_FLOAT> getFreqRef (uint8_t Mode,
	                        int16_t symbol, int16_t carrier) {
struct timeCells *table;
int16_t	i;
...
std::complex<DRM_FLOAT>	getPilotValue (uint8_t Mode,
...
int16_t	p	= (int16_t)((DRM_FLOAT(carrier - k0 - n * x)) / (x * y));
