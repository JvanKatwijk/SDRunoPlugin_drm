...
//	all have sufficient length
	summedCorrelations	= new std::complex<float> [nSamples];
	summedSquares		= new float [nSamples];
	EPSILON			= 1.0E-10;
}
...
int16_t* b = (int16_t*)_malloca (nSymbols * sizeof (int16_t));
